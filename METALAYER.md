# bstack-sensor-absence — Control Metalayer

Behavioral governance manifest for the bstack-sensor-absence workspace. This file is scaffolded by `bstack bootstrap` and is the authoritative declaration of the workspace's control plant, controller, safety shields, and feedback loop.
