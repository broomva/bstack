# bstack-redact — Control Metalayer

Behavioral governance manifest for the bstack-redact workspace. This file is scaffolded by `bstack bootstrap` and is the authoritative declaration of the workspace's control plant, controller, safety shields, and feedback loop.
